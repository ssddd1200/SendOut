...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="/QKSendOutBySSM/getCousmer?name=" class="active"><i class="fa fa-fw fa-table"></i>消费者管理</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group input-group" id="search-from-list">
                            <input name="searcher" type="text" class="form-control" placeholder="搜索相关用户">
	...
	<script type="text/javascript">
		...
		function del(id){
			window.location = "/QKSendOutBySSM/delCousmer?id="+id; 
		}
		...
		$("#find").click(function(){
			...
			window.location="/QKSendOutBySSM/getCousmer?name="+user;
		})
