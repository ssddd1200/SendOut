...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="shops.jsp" class="active"><i class="fa fa-fw fa-table"></i>商家管理</a>
                    </li>
                    <li>
	...
	<script type="text/javascript">
		function put(id){
			window.location="shopStatus?id="+id+"&&st=已通过";
			/* $.ajax({
		...
		function stop(id){
			window.location="shopStatus?id="+id+"&&st=未通过";
			/* $.ajax({
		...
		$.ajax({
			...
			success : function(data) {
				...
				$(".welcome")[1].innerHTML = "<h1>hi，" + data + "</h1>";
			},
			error : function(date) {
